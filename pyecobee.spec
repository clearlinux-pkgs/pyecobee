...
%patch -P 1 -p1
pushd ..
cp -a Pyecobee-31f950ee3a104c4ab5bdd7cb788b3d06076ccced buildavx2
popd
...
cp %{_builddir}/Pyecobee-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pyecobee/ac588e21dd3076fd0d39cf9633b8e319a30a223d || :
